const MANIFEST_FILE_NAME = "vstext.json";
const MANIFEST_DIR_NAME = "vstext";
...
function isSupportedTextExtension(input) {
  return textExtensionSet.has(getExtensionToken(input));
}

function isSupportedBinaryExtension(input) {
...
function compareByResolvedAtDesc(left, right) {
...
function normalizeBootstrapPayload(payload, fallbackDisplayName = "") {
...
function normalizeSessionPayload(payload, relativePath) {
...
function normalizeDraftPayload(payload, relativePath) {
...
function normalizeResolutionPayload(payload, relativePath) {
