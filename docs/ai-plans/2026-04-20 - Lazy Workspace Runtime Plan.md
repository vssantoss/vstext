...
- Aggressively simplify the codebase around what ships today while reorganizing provider code into a clean foundation for upcoming OneDrive/Google Drive/Dropbox work.
